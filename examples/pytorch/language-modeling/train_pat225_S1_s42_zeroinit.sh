#! /bin/bash
#SBATCH --job-name=PAT225_S1_s42_zeroinit
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/S1_s42_zeroinit/train/%j_pat225_S1_s42_zeroinit.txt
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/S1_s42_zeroinit"
