#! /bin/bash
#SBATCH --job-name=PAT227_B2
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat227_grid/B2_K4cap512_s42/train/%j_pat225_S1_s42.txt
...
# PAT-227: grid 2x2 ablation — B2_K4cap512, s42
...
RUN_OUT="${WORKDIR}/runs/pat227_grid/B2_K4cap512_s42"
