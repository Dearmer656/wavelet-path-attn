#!/bin/bash
#SBATCH --job-name=PAT234_K3_L256_withnull_sqrt_elm65
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K3_me12_14_15p1699_noC1_s42_withnull_sqrt_L256_elm65_a6000x2_bs2/train/%j_K3_me12_14_15p1699_withnull_sqrt_L256_elm65_a6000x2_bs2_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K3_me12_14_15p1699_noC1_s42_withnull_sqrt_L256_elm65_a6000x2_bs2"
MASTER_PORT=$((12000 + SLURM_JOB_ID % 20000))
mkdir -p "${RUN_OUT}/train"

cat > "${RUN_OUT}/supply_model.cfg" <<'EOF'
