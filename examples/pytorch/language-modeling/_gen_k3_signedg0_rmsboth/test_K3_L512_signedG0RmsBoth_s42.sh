#!/bin/bash
#SBATCH --job-name=hp2048_K3_signedG0RmsBoth_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K3_L512_signedG0RmsBoth_s42_ckpt15000_hotpot2048.txt
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_signedG0RmsBoth_128_256_384_s42/checkpoint-15000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_signedG0RmsBoth_128_256_384_s42/supply_model.cfg"
BLOCK_SIZE=2048
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K3_L512_signedG0RmsBoth_128_256_384_s42_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: K3_L512_signedG0RmsBoth_s42 L${BLOCK_SIZE} ==="
