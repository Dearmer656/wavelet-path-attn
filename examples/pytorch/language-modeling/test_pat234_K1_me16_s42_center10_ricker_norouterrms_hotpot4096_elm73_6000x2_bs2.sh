#!/bin/bash
#SBATCH --job-name=hp4096_K1cq_norrms_elm73
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_me16_noC1_s42_center10_ricker_norouterrms_elm73_6000x2_ckpt15000_hotpot4096_elm73_6000x2_bs2.txt
...
MODEL_NAME="K1_me16_noC1_s42_center10_ricker_norouterrms_elm73_6000x2_ckpt15000"
BLOCK_SIZE=4096
