...
# PAT-234: QWAB capacity test — K=1, max_exp 8, CENTER OFF (variant A).
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me8_C_s42"
MASTER_PORT=$(( 24234 + SLURM_JOB_ID % 1000 ))

echo "================= BEGIN RUN PAT-234 K1 me8 C (center ON) s42 ================="
