#! /bin/bash
#SBATCH --job-name=PAT234_K1_me8_NOnorm_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me8_NOnorm_s42/train/%j_train.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me8_NOnorm_s42"
