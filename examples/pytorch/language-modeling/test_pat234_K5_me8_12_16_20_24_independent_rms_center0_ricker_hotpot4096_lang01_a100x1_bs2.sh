#!/bin/bash
#SBATCH --job-name=hp4096_K5indRMS_1g
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K5_me8_12_16_20_24_independent_rms_center0_ricker_lang01_a100x1_ckpt15000_hotpot4096_lang01_a100x1_bs2.txt
...
RUN_OUT="${LANG_MODEL_DIR}/runs/pat234_scale_card/K5_me8_12_16_20_24_noC1_s42_independent_rms_center0_ricker_lang01_a100x2"
CHECKPOINT="${RUN_OUT}/checkpoint-15000"
CFG_PATH="${RUN_OUT}/supply_model.cfg"
MODEL_NAME="K5_me8_12_16_20_24_noC1_s42_independent_rms_center0_ricker_lang01_a100x1_ckpt15000"
BLOCK_SIZE=4096
...
/cl/work5/hongyu-s/conda/envs/latest_transformers/bin/torchrun --nproc_per_node=1 --master_port=${MASTER_PORT} ./run_clm.py \
    --model_type gpt2 \
    --tokenizer_name gpt2 \
