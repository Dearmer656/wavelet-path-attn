#! /bin/bash
#SBATCH --job-name=PAT225_K5_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/K5_s43/train/%j_pat225_K5_s43.txt
...
# PAT-225 mechanism test: K=5 full support, s43 (3-seed backfill)
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/K5_s43"
