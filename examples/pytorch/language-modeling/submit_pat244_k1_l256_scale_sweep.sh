#!/bin/bash
# PAT-244: K1 L256 scale sweep (gap-fill). Only me14/rho128 had ever been run at
# L256 (as part of the router-mode comparison); no scale sweep existed there,
# unlike the 8-point L512 K1 sweep. Adds me12/rho64 and me16/rho256 to bracket
# K3's own L256 scales (rho=64/128/192), both under the fixed "optimal setting"
# (with_null + rms_joint).
set -euo pipefail
...
# args: tag  K  scale_max_exp_pycfg  norm_mode  gres_directive  [multiscale_norm]  [router_sigmoid_mode]
emit_and_submit() {
