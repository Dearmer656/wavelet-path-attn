#! /bin/bash
#SBATCH --job-name=k8_scale_heatmap
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/_k8heatmap_%j.txt
