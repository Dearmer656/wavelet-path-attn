#!/bin/bash
#SBATCH --job-name=hp4096_K4sqrt_postfix_elm26
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K4_me8_16_20_24_noC1_s42_independent_sqrt_center0_ricker_postfix_elm26_q6000x2_ckpt15000_hotpot4096_bs2.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K4_me8_16_20_24_noC1_s42_independent_sqrt_center0_ricker_postfix_elm26_q6000x2"
CHECKPOINT="${RUN_OUT}/checkpoint-15000"
CFG_PATH="${RUN_OUT}/supply_model.cfg"
MODEL_NAME="K4_me8_16_20_24_noC1_s42_independent_sqrt_center0_ricker_postfix_elm26_q6000x2_ckpt15000"
BLOCK_SIZE=4096
