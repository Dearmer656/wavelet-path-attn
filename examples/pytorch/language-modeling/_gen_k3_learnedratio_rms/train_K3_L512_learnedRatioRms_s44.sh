#!/bin/bash
#SBATCH --job-name=K3_L512_learnedRatioRms_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_learnedRatioRms_128_256_384_s44/train/%j_K3_L512_learnedRatioRms_s44_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_learnedRatioRms_128_256_384_s44"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_k3_learnedratio_rms/test_K3_L512_learnedRatioRms_s44.sh"
