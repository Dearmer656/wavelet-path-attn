#!/bin/bash
#SBATCH --job-name=postfix_L128_hp4096sub2k_K1_rho256_morlet_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_postfix_L128_K1_rho256_morlet_s42_ckpt15000_hotpot4096sub2k.txt
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_postfix_docorder_L128/K1_rho256_morlet_s42/checkpoint-15000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_postfix_docorder_L128/K1_rho256_morlet_s42/supply_model.cfg"
BLOCK_SIZE=4096
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/postfix_L128_K1_rho256_morlet_s42_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: postfix_L128_K1_rho256_morlet_s42 L${BLOCK_SIZE} ==="
