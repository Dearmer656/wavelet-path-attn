#!/bin/bash
#SBATCH --job-name=postfix_L128_hp2048_PA_only_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_postfix_L128_PA_only_s42_ckpt15000_hotpot2048.txt
