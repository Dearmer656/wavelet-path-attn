#!/bin/bash
#SBATCH --job-name=PAT243_g0_gate_heatmap
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/pat243_g0_gate_analysis/%j_pat243_g0_gate_heatmap.txt
...
mkdir -p pat243_g0_gate_analysis
...
python analyze_k1_g0_gate_by_checkpoint.py \
  ...
  --output_dir pat243_g0_gate_analysis \
  --eval_length 512 \
  --num_samples 32 \
  --seed 42 \
  --device cuda \
