#!/bin/bash
#SBATCH --job-name=K3_L512_learnedStaticRmsBoth_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_learnedStaticRmsBoth_128_256_384_s44/train/%j_K3_L512_learnedStaticRmsBoth_s44_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_learnedStaticRmsBoth_128_256_384_s44"
...
wavelet_ctxscale_ratio_learnable=true
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_k3_learnedstatic_rmsboth/test_K3_L512_learnedStaticRmsBoth_s44.sh"
