#! /bin/bash
#SBATCH --job-name=PAT225_S4_s43_zeroinit
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/S4_s43_zeroinit/train/%j_pat225_S4_s43_zeroinit.txt
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/S4_s43_zeroinit"
