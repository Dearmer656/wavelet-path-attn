#! /bin/bash
#SBATCH --job-name=PAT234_K1_me28_C_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me28_C_s43/train/%j_train.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me28_C_s43"
...
echo "=== PAT-234 K1 me28 A s43 done ==="
