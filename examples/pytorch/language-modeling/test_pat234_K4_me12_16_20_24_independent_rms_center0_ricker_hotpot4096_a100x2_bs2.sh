#!/bin/bash
#SBATCH --job-name=hp4096_K4me12_indRMS_c0
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K4_me12_16_20_24_noC1_s42_independent_rms_center0_ricker_ckpt15000_hotpot4096_a100x2_bs2.txt
