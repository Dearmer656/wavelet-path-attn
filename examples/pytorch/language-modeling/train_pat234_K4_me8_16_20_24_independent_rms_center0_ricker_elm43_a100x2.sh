#!/bin/bash
#SBATCH --job-name=PAT234_K4indRMS_c0_elm43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K4_me8_16_20_24_noC1_s42_independent_rms_center0_ricker/train/%j_K4_independent_rms_center0_train_eval_elm43_a100x2.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K4_me8_16_20_24_noC1_s42_independent_rms_center0_ricker"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K4_me8_16_20_24_independent_rms_center0_ricker_hotpot4096_elm43_a100x2_bs2.sh"
