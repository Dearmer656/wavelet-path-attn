#!/bin/bash
# 3-seed backfill for per-head+detach rho=256 (s42 already done: L512=0.7664,
# L2048=0.7318, L4096=0.6820). Seed 44. Same base checkpoint/seed convention
# as the head-shared 3-seed runs (_gen_3seed_complete/train_K1_L512_me18_rho512_ricker_s43.sh):
# model_name_or_path=runs/1r_baseline_from_s/checkpoint-80000, only --seed differs.

set -euo pipefail

WORKDIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling"
TAG="perheadrouter_K1_L512_me16_rho256_detach_s44"
