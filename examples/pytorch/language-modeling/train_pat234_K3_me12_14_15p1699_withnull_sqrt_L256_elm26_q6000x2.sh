#!/bin/bash
#SBATCH --job-name=PAT234_K3_L256_withnull_sqrt
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K3_me12_14_15p1699_noC1_s42_withnull_sqrt_L256_elm26_q6000x2/train/%j_K3_me12_14_15p1699_withnull_sqrt_L256_elm26_q6000x2_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K3_me12_14_15p1699_noC1_s42_withnull_sqrt_L256_elm26_q6000x2"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K3_me12_14_15p1699_withnull_sqrt_L256_elm26_q6000x2_hotpot2048_bs2.sh"
