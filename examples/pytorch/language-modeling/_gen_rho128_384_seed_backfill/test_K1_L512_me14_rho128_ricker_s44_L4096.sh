#!/bin/bash
#SBATCH --job-name=hp4096_K1_L512_me14_rho128_ricker_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_L512_me14_rho128_ricker_s44_L4096.txt
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K1_L512_me14_rho128_ricker_s44_ckpt15000/L${BLOCK_SIZE}"
