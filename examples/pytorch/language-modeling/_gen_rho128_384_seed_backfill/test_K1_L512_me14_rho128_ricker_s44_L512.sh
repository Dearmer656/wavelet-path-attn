#!/bin/bash
#SBATCH --job-name=hp512_K1_L512_me14_rho128_ricker_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_L512_me14_rho128_ricker_s44_L512.txt
