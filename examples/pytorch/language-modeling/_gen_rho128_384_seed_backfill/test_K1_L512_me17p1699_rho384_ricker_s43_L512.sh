#!/bin/bash
#SBATCH --job-name=hp512_K1_L512_me17p1699_rho384_ricker_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_L512_me17p1699_rho384_ricker_s43_L512.txt
