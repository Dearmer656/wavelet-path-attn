#!/bin/bash
#SBATCH --job-name=hp2048_K3_fixedratioRmsBoth_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K3_L512_fixedratioRmsBoth_s42_ckpt15000_hotpot2048.txt
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K3_L512_fixedratioRmsBoth_128_256_384_s42_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: K3_L512_fixedratioRmsBoth_s42 L${BLOCK_SIZE} ==="
