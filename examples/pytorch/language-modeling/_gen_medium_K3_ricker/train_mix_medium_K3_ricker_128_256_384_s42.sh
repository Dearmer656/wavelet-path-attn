#!/bin/bash
#SBATCH --job-name=MedMix_K3ricker_128_256_384_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/mix_medium_K3_ricker_128_256_384_s42/train/%j_train.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/mix_medium_K3_ricker_128_256_384_s42"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_medium_K3_ricker/test_mix_medium_K3_ricker_128_256_384_s42.sh"
echo "=== Done: mix_medium_K3_ricker_128_256_384_s42 ==="
