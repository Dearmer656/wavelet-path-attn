#!/bin/bash
#SBATCH --job-name=hp4096_K1cq_norrms_a100_1g
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_me16_noC1_s42_center10_ricker_norouterrms_lang01_a100x1_ckpt15000_hotpot4096_lang01_a100x1_bs2.txt
...
MODEL_NAME="K1_me16_noC1_s42_center10_ricker_norouterrms_lang01_a100x2_ckpt15000"
BLOCK_SIZE=4096
