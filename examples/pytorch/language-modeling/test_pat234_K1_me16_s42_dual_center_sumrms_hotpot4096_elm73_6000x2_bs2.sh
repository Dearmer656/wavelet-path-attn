#!/bin/bash
#SBATCH --job-name=hp4096_K1s42dualSumRMS_elm73
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_hp4096_K1_me16_s42_dual_center_sumrms_elm73_6000x2_bs2.txt
