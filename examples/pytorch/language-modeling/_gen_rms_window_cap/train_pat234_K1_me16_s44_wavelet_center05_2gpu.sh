#!/bin/bash
#SBATCH --job-name=PAT234_K1_me16_wavelet_c05_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me16_noC1_s44_wavelet_center05/train/%j_K1_me16_wavelet_center05_s44_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me16_noC1_s44_wavelet_center05"
...
echo "=== Done training: K1_me16_wavelet_center05_s44 ==="
