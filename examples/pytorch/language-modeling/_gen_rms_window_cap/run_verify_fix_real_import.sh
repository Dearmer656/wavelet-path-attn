#!/bin/bash
#SBATCH --job-name=verify_fix_real
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_rms_window_cap/logs/%j_verify_fix_real.txt
...
python ./verify_fix_real_import.py
echo "=== done ==="
