#!/bin/bash
#SBATCH --job-name=hp4096_K1s44_dcnosqrt
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_hp4096_K1_me16_s44_dual_center_nosqrt.txt
...
RUN_OUT="${LANG_MODEL_DIR}/runs/pat234_scale_card/K1_me16_noC1_s44_dual_center_seprms_nosqrt"
CHECKPOINT="${RUN_OUT}/checkpoint-15000"
CFG_PATH="${RUN_OUT}/supply_model.cfg"
MODEL_NAME="K1_me16_s44_dual_center_seprms_nosqrt_ckpt15000"
BLOCK_SIZE=4096
