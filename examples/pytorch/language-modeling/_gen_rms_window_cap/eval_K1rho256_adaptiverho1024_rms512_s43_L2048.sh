#!/bin/bash
#SBATCH --job-name=hp2048_adaptrho_rms512_K1rho256_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1rho256_s43_adaptiverho1024_rms512_ckpt15000_hotpot2048.txt
...
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me16_rho256_seed43/scale_swap_cfgs/test_rho1024_rms512.cfg"
BLOCK_SIZE=2048
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K1_L512_me16_rho256_s43_adaptiverho1024_rms512_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: K1rho256_s43 adaptive-rho=1024 + rms_train_window=512 L${BLOCK_SIZE} ==="
