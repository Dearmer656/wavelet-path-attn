#!/bin/bash
#SBATCH --job-name=hp2048_shiftmax2_fixedratioRmsBoth_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_shiftmax2_fixedratioRmsBoth_s42_ckpt15000_hotpot2048.txt
...
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_fixedratioRmsBoth_128_256_384_s42/supply_model_shiftmax2.cfg"
BLOCK_SIZE=2048
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K3_L512_fixedratioRmsBoth_shiftmax2_128_256_384_s42_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: fixedratioRmsBoth_shiftmax2_s42 L${BLOCK_SIZE} ==="
