#!/bin/bash
#SBATCH --job-name=K1_me16_dualcenter_nosqrt_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me16_noC1_s43_dual_center_seprms_nosqrt/train/%j_dual_center_nosqrt_s43_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me16_noC1_s43_dual_center_seprms_nosqrt"
...
echo "=== Done training: K1_me16_dualcenter_nosqrt_s43 ==="
