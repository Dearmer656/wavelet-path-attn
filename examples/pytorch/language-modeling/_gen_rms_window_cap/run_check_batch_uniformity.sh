#!/bin/bash
#SBATCH --job-name=check_batch_unif
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_rms_window_cap/logs/%j_check_batch_unif.txt
...
python ./check_batch_uniformity.py
echo "=== done ==="
