#!/bin/bash
#SBATCH --job-name=hp4096_K1s44_center10
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_hp4096_K1_me16_s44_wavelet_center10.txt
...
RUN_OUT="${LANG_MODEL_DIR}/runs/pat234_scale_card/K1_me16_noC1_s44_wavelet_center10"
CHECKPOINT="${RUN_OUT}/checkpoint-15000"
CFG_PATH="${RUN_OUT}/supply_model.cfg"
MODEL_NAME="K1_me16_s44_wavelet_center10_ckpt15000"
BLOCK_SIZE=4096
