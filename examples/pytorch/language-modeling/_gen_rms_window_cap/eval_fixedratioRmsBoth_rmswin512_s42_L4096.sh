#!/bin/bash
#SBATCH --job-name=hp4096_rmswin512_fixedratioRmsBoth_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_rmswin512_fixedratioRmsBoth_s42_ckpt15000_hotpot4096.txt
...
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_fixedratioRmsBoth_128_256_384_s42/supply_model_rmswindow512.cfg"
BLOCK_SIZE=4096
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K3_L512_fixedratioRmsBoth_rmswin512_128_256_384_s42_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: fixedratioRmsBoth_rmswin512_s42 L${BLOCK_SIZE} ==="
