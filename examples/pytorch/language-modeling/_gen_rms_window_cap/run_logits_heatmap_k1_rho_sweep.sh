#!/bin/bash
#SBATCH --job-name=logits_k1_rho_sweep
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_rms_window_cap/logs/%j_logits_k1_rho_sweep.txt
...
python3 plot_logits_heatmap_k1_rho_sweep.py
