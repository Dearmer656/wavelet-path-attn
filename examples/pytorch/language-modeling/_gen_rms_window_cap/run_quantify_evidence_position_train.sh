#!/bin/bash
#SBATCH --job-name=quant_ev_pos_train
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_rms_window_cap/logs/%j_quant_ev_pos_train.txt
...
python ./quantify_evidence_position_train.py
echo "=== done ==="
