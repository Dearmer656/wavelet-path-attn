#!/bin/bash
#SBATCH --job-name=hp4096_rmswin512_fixedratioRmsBoth_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_rmswin512_fixedratioRmsBoth_s44_ckpt15000_hotpot4096.txt
