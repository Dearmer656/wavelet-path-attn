#!/bin/bash
#SBATCH --job-name=hp4096_adaptrho_K1rho256_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1rho256_s43_adaptiverho2048_ckpt15000_hotpot4096.txt
...
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me16_rho256_seed43/scale_swap_cfgs/test_rho2048.cfg"
BLOCK_SIZE=4096
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K1_L512_me16_rho256_s43_adaptiverho2048_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: K1rho256_s43 adaptive-rho=2048 (trained rho=256, alpha=0.5) L${BLOCK_SIZE} ==="
