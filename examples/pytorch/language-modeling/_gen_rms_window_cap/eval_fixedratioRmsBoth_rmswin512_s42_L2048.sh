#!/bin/bash
#SBATCH --job-name=hp2048_rmswin512_fixedratioRmsBoth_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_rmswin512_fixedratioRmsBoth_s42_ckpt15000_hotpot2048.txt
