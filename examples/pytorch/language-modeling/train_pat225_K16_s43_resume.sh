#! /bin/bash
#SBATCH --job-name=PAT225_K16_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/K16_s43/train/%j_pat225_K16_s43.txt
#SBATCH --partition=gpu_long
#SBATCH --gres=gpu:p6000:2 --nodelist=elm82
#SBATCH --time=100:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4

# PAT-225 mechanism test: K=16 full support, s43 (3-seed backfill)
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/K16_s43"
