#! /bin/bash
#SBATCH --job-name=PAT162_hln_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/small_hidden_ln_s43/train/%j_small_hidden_ln_s43.txt
...
# PAT-162: QWAB-Hidden-LN ablation — GPT-2 small, s43 (3-seed backfill)
...
RUN_OUT="${WORKDIR}/runs/small_hidden_ln_s43"
MASTER_PORT=$(( 24162 + SLURM_JOB_ID % 1000 ))

echo "================= BEGIN RUN PAT-162 small hidden_ln s43 ================="
...
echo "=== PAT-162 small hidden_ln s43 done ==="
