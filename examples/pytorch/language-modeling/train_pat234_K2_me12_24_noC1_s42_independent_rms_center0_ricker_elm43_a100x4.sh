#!/bin/bash
#SBATCH --job-name=PAT234_K2me12_24_indRMS_c0
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K2_me12_24_noC1_s42_independent_rms_center0_ricker/train/%j_K2_me12_24_independent_rms_center0_train_eval_elm43_a100x4.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K2_me12_24_noC1_s42_independent_rms_center0_ricker"
...
wavelet_ctxscale_k=2
wavelet_ctxscale_scale_max_exp=[12, 24]
multiscale_norm="rms"
...
bash "${WORKDIR}/test_pat234_K2_me12_24_independent_rms_center0_ricker_hotpot4096_elm43_a100x4_bs2.sh"
