#!/bin/bash
#SBATCH --job-name=hp4096_K1m22_c0_norrms
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_me22_noC1_s42_center0_ricker_norouterrms_a6000x2_noelm66_ckpt15000_hotpot4096_bs2.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me22_noC1_s42_center0_ricker_norouterrms_a6000x2_noelm66"
CHECKPOINT="${RUN_OUT}/checkpoint-15000"
CFG_PATH="${RUN_OUT}/supply_model.cfg"
MODEL_NAME="K1_me22_noC1_s42_center0_ricker_norouterrms_a6000x2_noelm66_ckpt15000"
BLOCK_SIZE=4096
