#! /bin/bash
#SBATCH --job-name=PAT234_K1_me24_noC1_signed_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me24_noC1_signed_s42/train/%j_pat225_S1_me0_s42.txt
...
# PAT-225: scale-cardinality ablation — GPT-2 small, S=1, s42
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me24_noC1_signed_s42"
