#!/bin/bash
#SBATCH --job-name=K3_L512_signed_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_signed_128_256_384_s44/train/%j_K3_L512_signed_s44_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_signed_128_256_384_s44"
