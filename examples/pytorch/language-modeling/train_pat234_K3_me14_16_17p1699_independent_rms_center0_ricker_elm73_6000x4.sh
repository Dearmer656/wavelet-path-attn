#!/bin/bash
#SBATCH --job-name=PAT234_K3rho128_256_384_indRMS_c0
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K3_me14_16_17p1699_noC1_s42_independent_rms_center0_ricker_elm73_6000x4/train/%j_K3_me14_16_17p1699_independent_rms_center0_train_eval_elm73_6000x4.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K3_me14_16_17p1699_noC1_s42_independent_rms_center0_ricker_elm73_6000x4"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K3_me14_16_17p1699_independent_rms_center0_ricker_hotpot4096_elm73_6000x4_bs2.sh"
