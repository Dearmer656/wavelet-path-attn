#!/bin/bash
#SBATCH --job-name=hp4096_K1restore
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_hp4096_K1_me16_restorebin0_s42.txt
...
RUN_OUT="${LANG_MODEL_DIR}/runs/pat239_pl4_ablation/K1_me16_restorebin0_s42"
CHECKPOINT="${RUN_OUT}/checkpoint-15000"
CFG_PATH="${RUN_OUT}/supply_model.cfg"
MODEL_NAME="pat239_K1_me16_restorebin0_s42_ckpt15000"
BLOCK_SIZE=4096
