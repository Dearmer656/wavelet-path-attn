#! /bin/bash
#SBATCH --job-name=PAT227_D2
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat227_grid/D2_K4cap8192_s42/train/%j_pat225_S1_s42.txt
...
# PAT-229: grid support sweep — D2_K4cap8192, s42
...
RUN_OUT="${WORKDIR}/runs/pat227_grid/D2_K4cap8192_s42"
