#!/bin/bash
#SBATCH --job-name=eval_fixedanchor_pct0_reference
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me16_rho256_ricker_rerun_s42/eval/%j_eval.txt
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me16_rho256_ricker_rerun_s42/eval_L512_target0"
mkdir -p "${OUTPUT_DIR}"
...
echo "=== Done: fixedanchor pct0 (original rho256) eval @ target0 ==="
