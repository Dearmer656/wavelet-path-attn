#!/bin/bash
#SBATCH --job-name=eval_fixedanchor_pct0p75
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_rho256_fixedanchor_pct0p75_s42/eval/%j_eval.txt
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_rho256_fixedanchor_pct0p75_s42/eval_L512_target0p75"
mkdir -p "${OUTPUT_DIR}"
