#!/bin/bash
#SBATCH --job-name=eval_fixedanchor_pct1p0_L4096_fp
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_fixedanchor_pct1p0_s42_L4096_frontpinned.txt
