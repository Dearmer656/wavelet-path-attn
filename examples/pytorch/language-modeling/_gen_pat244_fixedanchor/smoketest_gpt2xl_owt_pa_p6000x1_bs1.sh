#!/bin/bash
#SBATCH --job-name=smoketest_gpt2xl_p6000_bs1
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/smoketest_gpt2xl_owt_pa/%j_smoketest.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/smoketest_gpt2xl_owt_pa"
mkdir -p "${RUN_OUT}"
...
echo "=== smoketest gpt2-xl PA-only p6000x1 bs1 done ==="
