#!/bin/bash
#SBATCH --job-name=PAT_fixedanchor_pct1p0_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_rho256_fixedanchor_pct1p0_s42/train/%j_train.txt
#SBATCH --partition=gpu_long
#SBATCH --gres=gpu:3090:2
#SBATCH --nodelist=elm53
#SBATCH --ntasks=1
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_rho256_fixedanchor_pct1p0_s42"
...
wavelet_ctxscale_center_pos_fixed_ratio=1.0
hotpot_train_center_target_pct=1.0
