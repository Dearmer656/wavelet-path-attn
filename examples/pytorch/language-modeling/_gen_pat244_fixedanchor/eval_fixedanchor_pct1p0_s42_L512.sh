#!/bin/bash
#SBATCH --job-name=eval_fixedanchor_pct1p0
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_rho256_fixedanchor_pct1p0_s42/eval/%j_eval.txt
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_rho256_fixedanchor_pct1p0_s42/eval_L512_target1p0"
mkdir -p "${OUTPUT_DIR}"
