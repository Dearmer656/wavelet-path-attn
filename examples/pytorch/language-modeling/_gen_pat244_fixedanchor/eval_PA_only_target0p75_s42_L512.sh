#!/bin/bash
#SBATCH --job-name=eval_PAonly_target0p75
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/PA_baseline_multi_seeds/token_even_mix_PA_s42/eval/%j_eval.txt
...
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_pat244_fixedanchor/PA_only_target0p75.cfg"
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/PA_baseline_multi_seeds/token_even_mix_PA_s42/eval_L512_target0p75"
mkdir -p "${OUTPUT_DIR}"
...
echo "=== Done: PA-only eval @ target0.5 ==="
