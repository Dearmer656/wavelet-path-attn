#!/bin/bash
#SBATCH --job-name=eval_fixedanchor_pct0p75_L4096_fp
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_fixedanchor_pct0p75_s42_L4096_frontpinned.txt
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_rho256_fixedanchor_pct0p75_s42/checkpoint-15900"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_rho256_fixedanchor_pct0p75_s42/supply_model.cfg"
BLOCK_SIZE=4096
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/fixedanchor_pct0p75_s42_ckpt15900_frontpinned/L${BLOCK_SIZE}"
...
echo "=== Done: fixedanchor pct0.5 L${BLOCK_SIZE} frontpinned (standard protocol) ==="
