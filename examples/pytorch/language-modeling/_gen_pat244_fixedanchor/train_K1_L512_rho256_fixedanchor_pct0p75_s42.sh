#!/bin/bash
#SBATCH --job-name=PAT_fixedanchor_pct0p75_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_rho256_fixedanchor_pct0p75_s42/train/%j_train.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_rho256_fixedanchor_pct0p75_s42"
...
wavelet_ctxscale_center_pos_fixed_ratio=0.75
hotpot_train_center_target_pct=0.75
