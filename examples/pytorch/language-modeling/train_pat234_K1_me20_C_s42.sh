#! /bin/bash
#SBATCH --job-name=PAT234_K1_me20_C_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me20_C_s42/train/%j_train.txt
...
# PAT-234: QWAB capacity test — K=1, max_exp 20, CENTER OFF (variant A).
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me20_C_s42"
MASTER_PORT=$(( 24234 + SLURM_JOB_ID % 1000 ))

echo "================= BEGIN RUN PAT-234 K1 me20 C (center ON) s42 ================="
