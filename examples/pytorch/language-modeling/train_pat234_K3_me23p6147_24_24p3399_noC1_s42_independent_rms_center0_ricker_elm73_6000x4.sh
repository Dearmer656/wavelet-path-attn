#!/bin/bash
#SBATCH --job-name=PAT234_K3fine24_indRMS_c0
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K3_me23p6147_24_24p3399_noC1_s42_independent_rms_center0_ricker/train/%j_K3_me23p6147_24_24p3399_independent_rms_center0_train_eval_elm73_6000x4.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K3_me23p6147_24_24p3399_noC1_s42_independent_rms_center0_ricker"
...
wavelet_ctxscale_scale_max_exp=[23.6147, 24, 24.3399]
multiscale_norm="rms"
...
bash "${WORKDIR}/test_pat234_K3_me23p6147_24_24p3399_independent_rms_center0_ricker_hotpot4096_elm73_6000x4_bs2.sh"
