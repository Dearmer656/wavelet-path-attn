#!/bin/bash
#SBATCH --job-name=PAT234_K1cq_norrms_a100_1g
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me16_noC1_s42_center10_ricker_norouterrms_lang01_a100x2/train/%j_K1_me16_s42_center10_ricker_norouterrms_lang01_a100x1_train_eval_fallback1g.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me16_noC1_s42_center10_ricker_norouterrms_lang01_a100x2"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K1_me16_s42_center10_ricker_norouterrms_hotpot4096_lang01_a100x1_bs2.sh"
