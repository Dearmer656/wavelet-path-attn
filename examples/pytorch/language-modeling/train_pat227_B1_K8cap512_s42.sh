#! /bin/bash
#SBATCH --job-name=PAT227_B1
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat227_grid/B1_K8cap512_s42/train/%j_pat225_S1_s42.txt
...
# PAT-227: grid 2x2 ablation — B1_K8cap512, s42
...
RUN_OUT="${WORKDIR}/runs/pat227_grid/B1_K8cap512_s42"
MASTER_PORT=$(( 24225 + SLURM_JOB_ID % 1000 ))

echo "================= BEGIN RUN PAT-227 B1_K8cap512 s42 ================="
...
echo "=== PAT-227 B1_K8cap512 s42 done ==="
