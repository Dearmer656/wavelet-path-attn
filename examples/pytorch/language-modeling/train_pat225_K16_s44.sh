#! /bin/bash
#SBATCH --job-name=PAT225_K16_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/K16_s44/train/%j_pat225_K16_s44.txt
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/K16_s44"
