#! /bin/bash
#SBATCH --job-name=PAT225_S1_me2_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/S1_me2_s42/train/%j_pat225_S1_me2_s42.txt
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/S1_me2_s42"
