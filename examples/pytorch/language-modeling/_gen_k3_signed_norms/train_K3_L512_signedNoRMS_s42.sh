#!/bin/bash
#SBATCH --job-name=K3_L512_signedNoRMS_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_signedNoRMS_128_256_384_s42/train/%j_K3_L512_signedNoRMS_s42_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_signedNoRMS_128_256_384_s42"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_k3_signed_norms/test_K3_L512_signedNoRMS_s42.sh"
