#!/bin/bash
#SBATCH --job-name=PAT234_K1m12_L256_c0_norrms_elm72
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me12_noC1_s42_center0_ricker_norouterrms_L256_elm72_6000x2/train/%j_K1_me12_s42_center0_ricker_norouterrms_L256_elm72_6000x2_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me12_noC1_s42_center0_ricker_norouterrms_L256_elm72_6000x2"
...
wavelet_ctxscale_scale_max_exp=12
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K1_me12_s42_center0_ricker_norouterrms_L256_elm72_6000x2_hotpot4096_bs2.sh"
