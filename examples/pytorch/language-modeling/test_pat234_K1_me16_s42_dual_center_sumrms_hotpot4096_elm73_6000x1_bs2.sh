#!/bin/bash
#SBATCH --job-name=hp4096_K1s42dualSumRMS_1g6000
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_hp4096_K1_me16_s42_dual_center_sumrms_elm73_6000x1_bs2.txt
...
MODEL_NAME="K1_me16_noC1_s42_dual_center_sumrms_ckpt15000"
BLOCK_SIZE=4096
