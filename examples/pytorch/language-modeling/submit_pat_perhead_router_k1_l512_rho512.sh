...
# QWAB medium pretrains right now; routed to elm54 (3090x4, idle) instead.
# 3090 is 24GB vs 6000's 48GB, so bs=16/accum=1 (the template's default) would
# OOM per the documented 24GB-card convention -- dropped to bs=8/accum=2
# (global_bs=64 unchanged).
