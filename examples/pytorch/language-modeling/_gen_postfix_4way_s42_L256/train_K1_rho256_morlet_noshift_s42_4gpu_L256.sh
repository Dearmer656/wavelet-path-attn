#!/bin/bash
#SBATCH --job-name=postfix_L256_K1_rho256_morlet_noshift_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_postfix_docorder_L256/K1_rho256_morlet_noshift_s42/train/%j_K1_rho256_morlet_noshift_s42_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_postfix_docorder_L256/K1_rho256_morlet_noshift_s42"
...
wavelet_ctxscale_shift_unit_max=0.0
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_postfix_4way_s42_L256/eval_K1_rho256_morlet_noshift_s42_L256.sh"
