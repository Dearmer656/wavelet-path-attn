#!/bin/bash
#SBATCH --job-name=postfix_L256_hp2048_PA_only_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_postfix_L256_PA_only_s42_ckpt15000_hotpot2048.txt
