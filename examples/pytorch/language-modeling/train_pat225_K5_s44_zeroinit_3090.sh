#! /bin/bash
#SBATCH --job-name=PAT225_K5_s44_zeroinit_3090
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/K5_s44_zeroinit/train/%j_pat225_K5_s44_zeroinit.txt
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/K5_s44_zeroinit"
