#!/bin/bash
#SBATCH --job-name=MedMix_K1rho384_hiddenln_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/mix_medium_K1_rho384_hiddenln_s42/train/%j_train.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/mix_medium_K1_rho384_hiddenln_s42"
...
sbatch "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_medium_hiddenln/test_mix_medium_K1_rho384_hiddenln_s42.sh"
echo "=== Done: mix_medium_K1_rho384_hiddenln_s42 ==="
