#!/bin/bash
#SBATCH --job-name=PAT234_K1m20_c0_norrms_elm73
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me20_noC1_s42_center0_ricker_norouterrms_elm73_6000x4/train/%j_K1_me20_s42_center0_ricker_norouterrms_elm73_6000x4_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me20_noC1_s42_center0_ricker_norouterrms_elm73_6000x4"
...
wavelet_ctxscale_scale_max_exp=20
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K1_me20_s42_center0_ricker_norouterrms_elm73_6000x4_hotpot4096_bs2.sh"
