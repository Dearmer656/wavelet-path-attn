#! /bin/bash
#SBATCH --job-name=pat234_K8_C_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/pat234_K8_C_s42/train/%j_pat225_pat234_K8_C_s42.txt
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/pat234_K8_C_s42"
