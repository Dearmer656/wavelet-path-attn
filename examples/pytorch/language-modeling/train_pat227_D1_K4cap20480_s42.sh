#! /bin/bash
#SBATCH --job-name=PAT227_D1
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat227_grid/D1_K4cap20480_s42/train/%j_pat225_S1_s42.txt
...
# PAT-229: grid support sweep — D1_K4cap20480 (beyond production range), s42
# One-factor delta from Full QWAB small (s42_delta_detach):
#   see supply_model.cfg: cap-512 grid (max_exp=9)
...
RUN_OUT="${WORKDIR}/runs/pat227_grid/D1_K4cap20480_s42"
MASTER_PORT=$(( 24225 + SLURM_JOB_ID % 1000 ))

echo "================= BEGIN RUN PAT-227 B2_K4cap512 s42 ================="
...
echo "=== PAT-227 B2_K4cap512 s42 done ==="
