#! /bin/bash
#SBATCH --job-name=PAT225_K8_s42_zeroinit_a100
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/K8_s42_zeroinit/train/%j_pat225_K8_s42_zeroinit.txt
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/K8_s42_zeroinit"
