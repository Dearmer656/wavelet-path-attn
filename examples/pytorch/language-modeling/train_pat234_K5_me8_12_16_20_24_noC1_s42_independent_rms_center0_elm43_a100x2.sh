#!/bin/bash
#SBATCH --job-name=PAT234_K5_independent_rms_s42_elm43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K5_me8_12_16_20_24_noC1_s42_independent_rms_center0_ricker_lang01_a100x2/train/%j_PAT234_K5_me8_12_16_20_24_independent_rms_s42_elm43_a100x2_train_eval.txt
...
bash "${WORKDIR}/test_pat234_K5_me8_12_16_20_24_independent_rms_center0_ricker_hotpot4096_elm43_a100x2_bs2.sh"
