...
series = [
    ...
    ("K1 ρ=128",         "#EE7733", "-",  2.25, 7, [0.8159, 0.8123, 0.8083, 0.7944, 0.7753, 0.7510], "o",
     [0.0026, 0.0025, 0.0023, 0.0057, 0.0089, 0.0143]),
    ("K1 ρ=256",         "#009988", "-",  2.25, 7, [0.8158, 0.8117, 0.8069, 0.7945, 0.7743, 0.7488], "^",
     [0.0013, 0.0011, 0.0016, 0.0017, 0.0031, 0.0048]),
    ("K3 [128,256,384]", "#33BBEE", "-",  2.9, 9, [0.8158, 0.8109, 0.8066, 0.7908, 0.7678, 0.7372], "*",
     [0.0002, 0.0012, 0.0019, 0.0019, 0.0063, 0.0132]),
]
