#! /bin/bash
#SBATCH --job-name=PAT225_K5_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/K5_s44/train/%j_pat225_K5_s44.txt
#SBATCH --partition=gpu_long
#SBATCH --gres=gpu:3090:2 --nodelist=elm55
#SBATCH --time=100:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4

# PAT-225 mechanism test: K=5 full support, s44 (3-seed backfill)
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/K5_s44"
