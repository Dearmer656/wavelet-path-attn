#!/bin/bash
#SBATCH --job-name=K3_L512_posNoRMS_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_posNoRMS_128_256_384_s43/train/%j_K3_L512_posNoRMS_s43_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_posNoRMS_128_256_384_s43"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_k3_pos_noouterrms/test_K3_L512_posNoRMS_s43.sh"
