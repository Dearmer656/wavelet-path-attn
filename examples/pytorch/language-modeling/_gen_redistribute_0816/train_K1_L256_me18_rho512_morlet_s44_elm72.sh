#!/bin/bash
#SBATCH --job-name=PAT244_K1_L256_me18_rho512_morlet_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L256_me18_rho512_morlet_s44/train/%j_K1_L256_me18_rho512_morlet_s44_train_eval.txt
#SBATCH --partition=gpu_long
#SBATCH --gres=gpu:6000:1 --nodelist=elm72
#SBATCH --ntasks=1
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L256_me18_rho512_morlet_s44"
...
wavelet_ctxscale_scale_max_exp=18
multiscale_norm="rms"
