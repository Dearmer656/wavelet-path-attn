#!/bin/bash
#SBATCH --job-name=PAT244_K1_L512_me12_rho64_ricker_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me12_rho64_ricker_s44/train/%j_K1_L512_me12_rho64_ricker_s44_train_eval.txt
#SBATCH --partition=gpu_long
#SBATCH --gres=gpu:a6000:1 --nodelist=elm64
#SBATCH --ntasks=1
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me12_rho64_ricker_s44"
