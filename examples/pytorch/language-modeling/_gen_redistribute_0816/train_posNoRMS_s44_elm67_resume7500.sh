#!/bin/bash
#SBATCH --job-name=K3_L512_posNoRMS_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_posNoRMS_128_256_384_s44/train/%j_K3_L512_posNoRMS_s44_train_eval.txt
#SBATCH --partition=gpu_long
#SBATCH --gres=gpu:a6000:4 --nodelist=elm67
#SBATCH --ntasks=1
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_posNoRMS_128_256_384_s44"
