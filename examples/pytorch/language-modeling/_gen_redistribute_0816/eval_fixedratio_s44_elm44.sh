#!/bin/bash
#SBATCH --job-name=hp2048_K3_fixedratio_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K3_L512_fixedratio_s44_ckpt15000_hotpot2048.txt
#SBATCH --partition=gpu_long
#SBATCH --gres=gpu:a100-80:1 --nodelist=elm44
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_fixedratio_128_256_384_s44/checkpoint-15000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K3_L512_fixedratio_128_256_384_s44/supply_model.cfg"
BLOCK_SIZE=2048
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K3_L512_fixedratio_128_256_384_s44_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: K3_L512_fixedratio_s44 L${BLOCK_SIZE} ==="
