#!/bin/bash
#SBATCH --job-name=hp4096_K3fine24_indRMS_c0
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K3_me23p6147_24_24p3399_noC1_s42_independent_rms_center0_ricker_ckpt15000_hotpot4096_elm73_6000x4_bs2.txt
...
RUN_OUT="${LANG_MODEL_DIR}/runs/pat234_scale_card/K3_me23p6147_24_24p3399_noC1_s42_independent_rms_center0_ricker"
CHECKPOINT="${RUN_OUT}/checkpoint-15000"
CFG_PATH="${RUN_OUT}/supply_model.cfg"
MODEL_NAME="K3_me23p6147_24_24p3399_noC1_s42_independent_rms_center0_ricker_ckpt15000"
BLOCK_SIZE=4096
