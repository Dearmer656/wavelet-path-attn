#!/bin/bash
#SBATCH --job-name=PAT234_K4me8_indRMS_c0_3090
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K4_me8_16_20_24_noC1_s42_independent_rms_center0_ricker_3090x4/train/%j_K4_me8_16_20_24_independent_rms_center0_train_eval_3090x4.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K4_me8_16_20_24_noC1_s42_independent_rms_center0_ricker_3090x4"
...
bash "${WORKDIR}/test_pat234_K4_me8_16_20_24_independent_rms_center0_ricker_hotpot4096_3090x4_bs2.sh"
