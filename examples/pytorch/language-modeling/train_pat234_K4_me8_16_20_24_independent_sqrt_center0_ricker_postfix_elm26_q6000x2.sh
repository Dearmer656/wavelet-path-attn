#!/bin/bash
#SBATCH --job-name=PAT234_K4sqrt_postfix_elm26
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K4_me8_16_20_24_noC1_s42_independent_sqrt_center0_ricker_postfix_elm26_q6000x2/train/%j_K4_me8_16_20_24_independent_sqrt_center0_train_eval_elm26_q6000x2.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K4_me8_16_20_24_noC1_s42_independent_sqrt_center0_ricker_postfix_elm26_q6000x2"
...
wavelet_ctxscale_scale_max_exp=[8, 16, 20, 24]
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K4_me8_16_20_24_independent_sqrt_center0_ricker_postfix_elm26_q6000x2_hotpot4096_bs2.sh"
