#! /bin/bash
#SBATCH --job-name=PAT225_S1_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/S1_s43/train/%j_pat225_S1_s43.txt
...
# PAT-225: scale-cardinality ablation — GPT-2 small, S=1, s43 (3-seed backfill)
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/S1_s43"
MASTER_PORT=$(( 24225 + SLURM_JOB_ID % 1000 ))

echo "================= BEGIN RUN PAT-225 S=1 s43 ================="
