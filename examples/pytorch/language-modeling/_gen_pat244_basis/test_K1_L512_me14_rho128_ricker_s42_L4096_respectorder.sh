#!/bin/bash
#SBATCH --job-name=hpNEW_K1_L512_me14_rho128_ricker_s42_L4096
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_L512_me14_rho128_ricker_s42_ckpt15000_hotpotL4096_new2.txt
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me14_rho128_ricker_s42/checkpoint-15000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_pat244_basis/respectorder_cfgs/rho128_s42_respectorder.cfg"
BLOCK_SIZE=4096
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K1_L512_me14_rho128_ricker_s42_ckpt15000_respectorder/L${BLOCK_SIZE}"
...
echo "=== Done: K1_L512_me14_rho128_ricker_s42 L${BLOCK_SIZE} (fresh, respect_doc_order) ==="
