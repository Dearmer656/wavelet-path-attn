...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/PA_baseline_multi_seeds/s43/checkpoint-15000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_pat244_basis/respectorder_cfgs/PA_only_s43_respectorder.cfg"
BLOCK_SIZE=4096
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/PA_only_s43_uniform_respectorder/L${BLOCK_SIZE}"
...
echo "=== Done: PA_only_s42 L${BLOCK_SIZE} (fresh, respect_doc_order, s43) ==="
