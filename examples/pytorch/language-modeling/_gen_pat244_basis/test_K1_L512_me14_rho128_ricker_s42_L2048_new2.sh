#!/bin/bash
#SBATCH --job-name=hpNEW_K1_L512_me14_rho128_ricker_s42_L2048
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_L512_me14_rho128_ricker_s42_ckpt15000_hotpot2048.txt
...
echo "=== Done: K1_L512_me14_rho128_ricker_s42 L${BLOCK_SIZE} ==="
