#!/bin/bash
#SBATCH --job-name=PAT244_K1_L512_me16_rho256_gaussian_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me16_rho256_gaussian_s42/train/%j_K1_L512_me16_rho256_gaussian_s42_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me16_rho256_gaussian_s42"
...
multiscale_norm="rms"
wavelet_ctxscale_pattern_mode="gaussian"
...
sbatch "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_pat244_basis/test_K1_L512_me16_rho256_gaussian_s42_L512.sh"
sbatch "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_pat244_basis/test_K1_L512_me16_rho256_gaussian_s42_L2048.sh"
sbatch "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_pat244_basis/test_K1_L512_me16_rho256_gaussian_s42_L4096.sh"
