#!/bin/bash
#SBATCH --job-name=hpL512_K1_L512_me16_rho256_ricker_rerun_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_L512_me16_rho256_ricker_rerun_s42_ckpt15000_hotpotL512.txt
