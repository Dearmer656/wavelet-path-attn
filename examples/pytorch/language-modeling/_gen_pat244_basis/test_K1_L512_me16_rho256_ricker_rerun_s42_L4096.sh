#!/bin/bash
#SBATCH --job-name=hpL4096_K1_L512_me16_rho256_ricker_rerun_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_L512_me16_rho256_ricker_rerun_s42_ckpt15000_hotpotL4096.txt
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K1_L512_me16_rho256_ricker_rerun_s42_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: K1_L512_me16_rho256_ricker_rerun_s42 L${BLOCK_SIZE} ==="
