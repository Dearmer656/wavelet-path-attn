#!/bin/bash
#SBATCH --job-name=PAT244_K1_L512_me16_rho256_gaussian_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me16_rho256_gaussian_s44/train/%j_K1_L512_me16_rho256_gaussian_s44_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me16_rho256_gaussian_s44"
