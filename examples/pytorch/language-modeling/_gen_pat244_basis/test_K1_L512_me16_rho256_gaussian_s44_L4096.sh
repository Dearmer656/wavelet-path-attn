#!/bin/bash
#SBATCH --job-name=hpL4096_K1_L512_me16_rho256_gaussian_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_L512_me16_rho256_gaussian_s44_ckpt15000_hotpotL4096.txt
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me16_rho256_gaussian_s44/checkpoint-15000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_me16_rho256_gaussian_s44/supply_model.cfg"
BLOCK_SIZE=4096
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K1_L512_me16_rho256_gaussian_s44_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: K1_L512_me16_rho256_gaussian_s44 L${BLOCK_SIZE} ==="
