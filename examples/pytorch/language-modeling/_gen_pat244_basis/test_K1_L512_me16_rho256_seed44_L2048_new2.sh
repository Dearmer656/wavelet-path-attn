#!/bin/bash
#SBATCH --job-name=hpNEW_K1_L512_me16_rho256_seed44_L2048
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_L512_me16_rho256_seed44_ckpt15000_hotpot2048.txt
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K1_L512_me16_rho256_seed44_ckpt15000_new2/L${BLOCK_SIZE}"
...
echo "=== Done: K1_L512_me16_rho256_seed44 L${BLOCK_SIZE} ==="
