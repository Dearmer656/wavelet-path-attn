#!/bin/bash
#SBATCH --job-name=hpNEW_K1_L512_me16_rho256_seed44_L4096
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_L512_me16_rho256_seed44_ckpt15000_hotpotL4096_new2.txt
...
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_pat244_basis/respectorder_cfgs/rho256_s44_respectorder.cfg"
BLOCK_SIZE=4096
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K1_L512_me16_rho256_seed44_ckpt15000_respectorder/L${BLOCK_SIZE}"
...
echo "=== Done: K1_L512_me16_rho256_seed44 L${BLOCK_SIZE} (fresh, respect_doc_order, s44) ==="
