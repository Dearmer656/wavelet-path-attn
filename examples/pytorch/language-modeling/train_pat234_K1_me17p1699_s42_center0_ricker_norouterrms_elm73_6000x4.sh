#!/bin/bash
#SBATCH --job-name=PAT234_K1m17p17_c0_norrms
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me17p1699_noC1_s42_center0_ricker_norouterrms_elm73_6000x4/train/%j_K1_me17p1699_s42_center0_ricker_norouterrms_elm73_6000x4_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me17p1699_noC1_s42_center0_ricker_norouterrms_elm73_6000x4"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K1_me17p1699_s42_center0_ricker_norouterrms_elm73_6000x4_hotpot4096_bs2.sh"
