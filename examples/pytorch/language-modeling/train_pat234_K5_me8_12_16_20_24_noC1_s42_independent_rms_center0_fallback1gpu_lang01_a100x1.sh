#!/bin/bash
#SBATCH --job-name=PAT234_K5_independent_rms_s42_1g
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K5_me8_12_16_20_24_noC1_s42_independent_rms_center0_ricker_lang01_a100x2/train/%j_PAT234_K5_me8_12_16_20_24_independent_rms_s42_lang01_a100x1_fallback1g_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K5_me8_12_16_20_24_noC1_s42_independent_rms_center0_ricker_lang01_a100x2"
...
wavelet_ctxscale_scale_max_exp=[8, 12, 16, 20, 24]
multiscale_norm="rms"
...
bash "${WORKDIR}/test_pat234_K5_me8_12_16_20_24_independent_rms_center0_ricker_hotpot4096_lang01_a100x1_bs2.sh"
