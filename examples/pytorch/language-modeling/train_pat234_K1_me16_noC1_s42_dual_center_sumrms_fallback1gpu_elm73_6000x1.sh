#!/bin/bash
#SBATCH --job-name=PAT234_K1m16_s42_dualSumRMS_1g6000
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me16_noC1_s42_dual_center_sumrms/train/%j_K1_dual_sumrms_fallback1g_train_eval_elm73_6000x1.txt
#SBATCH --partition=gpu_long
#SBATCH --gres=gpu:6000:1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --time=24:00:00
#SBATCH --chdir=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me16_noC1_s42_dual_center_sumrms"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K1_me16_s42_dual_center_sumrms_hotpot4096_elm73_6000x1_bs2.sh"
