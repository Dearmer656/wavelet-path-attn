#! /bin/bash
#SBATCH --job-name=PAT234_K1_me12_noC1_signed_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me12_noC1_signed_s42/train/%j_pat225_S1_me0_s42.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me12_noC1_signed_s42"
