#!/bin/bash
#SBATCH --job-name=PAT234_K1m22_c0_norrms
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me22_noC1_s42_center0_ricker_norouterrms_a6000x2_noelm66/train/%j_K1_me22_s42_center0_ricker_norouterrms_a6000x2_noelm66_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me22_noC1_s42_center0_ricker_norouterrms_a6000x2_noelm66"
...
wavelet_ctxscale_scale_max_exp=22
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K1_me22_s42_center0_ricker_norouterrms_a6000x2_noelm66_hotpot4096_bs2.sh"
