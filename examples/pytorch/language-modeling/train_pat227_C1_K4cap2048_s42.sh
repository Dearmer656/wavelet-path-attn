#! /bin/bash
#SBATCH --job-name=PAT227_C1
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat227_grid/C1_K4cap2048_s42/train/%j_pat225_S1_s42.txt
...
# PAT-229: grid support sweep — C1_K4cap2048, s42
...
RUN_OUT="${WORKDIR}/runs/pat227_grid/C1_K4cap2048_s42"
