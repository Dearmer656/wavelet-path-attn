...
# Table 4 (GPT-2 small) fill-in: QWAB/Ricker rho=128 at L8192/12288/16384
...
for BSIZE in 8192 12288 16384; do
  ...
  OUTPUT="${BASE}/hotpot_long/results_uniform/K1_L512_me14_rho128_ricker_s42_ckpt15000/L${BSIZE}"
  mkdir -p "${OUTPUT}"
  ...
  python3 -c "import json; d=json.load(open('${OUTPUT}/eval_results.json')); print(f'K1_rho128_ricker s42 L${BSIZE}: F1={d[\"eval_f1\"]:.4f}')"
done

echo "=== Done: K1 rho=128 Ricker s42 L8192/12288/16384 ==="
