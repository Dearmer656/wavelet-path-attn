#!/bin/bash
#SBATCH --job-name=ricker128_realbias_L2048
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_rho128_ricker_s42_L2048_a6000_realbias.txt
...
# Table 4 (GPT-2 small) QWAB/Ricker rho=128, L2048 only, REAL bias (pytorch impl, not triton).
...
echo "=== Done: K1 rho=128 Ricker s42 L2048 (a6000, real bias) ==="
