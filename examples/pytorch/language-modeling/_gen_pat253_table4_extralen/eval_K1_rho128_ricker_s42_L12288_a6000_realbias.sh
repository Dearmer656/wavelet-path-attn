#!/bin/bash
#SBATCH --job-name=ricker128_realbias_L12288
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_rho128_ricker_s42_L12288_a6000_realbias.txt
...
# Table 4 (GPT-2 small) QWAB/Ricker rho=128, L12288 only, REAL bias (pytorch impl, not triton).
...
BSIZE=12288
JSONL="${BASE}/hotpot_long/data/hotpot_long_dev_uniform_12288only.jsonl"
...
echo "=== Done: K1 rho=128 Ricker s42 L12288 (a6000, real bias) ==="
