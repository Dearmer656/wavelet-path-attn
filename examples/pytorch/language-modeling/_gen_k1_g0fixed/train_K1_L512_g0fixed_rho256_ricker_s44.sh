#!/bin/bash
#SBATCH --job-name=K1_L512_g0fixed_rho256_ricker_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_g0fixed_rho256_ricker_s44/train/%j_K1_L512_g0fixed_rho256_ricker_s44_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_g0fixed_rho256_ricker_s44"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_k1_g0fixed/test_K1_L512_g0fixed_rho256_ricker_s44.sh"
