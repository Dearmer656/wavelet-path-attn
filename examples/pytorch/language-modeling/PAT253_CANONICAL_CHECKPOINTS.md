...
- `K1_me16_noC1_s42` → L512=0.7599, L2048=0.7325, L4096=0.6858. This is the checkpoint Table 1's basis-ablation Ricker row (comment 7e0dccf9 in PAT-253) is built on. Located via the eval's auto-generated `README.md` model card: `base_model: runs/pat234_scale_card/K1_me16_noC1_s42/checkpoint-15000` (a PAT-234 scale-cardinality grid point). **This checkpoint has since been deleted from disk** (manually cleaned up, same pattern as the K3 Morlet checkpoint noted elsewhere in PAT-253) — it cannot be reproduced or re-verified. This resolves the reconciliation question below in practice: `K1_L512_me16_rho256_ricker_s42` is not just the chosen canonical checkpoint, it is the only one of the candidates that still exists.
