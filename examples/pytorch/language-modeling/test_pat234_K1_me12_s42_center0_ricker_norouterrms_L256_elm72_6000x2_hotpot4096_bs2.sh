#!/bin/bash
#SBATCH --job-name=hp4096_K1m12_L256_c0_norrms_elm72
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_me12_noC1_s42_center0_ricker_norouterrms_L256_elm72_6000x2_ckpt15000_hotpot4096_bs2.txt
