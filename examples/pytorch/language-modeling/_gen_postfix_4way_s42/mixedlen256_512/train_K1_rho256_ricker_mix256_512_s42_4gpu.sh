#!/bin/bash
#SBATCH --job-name=postfix_K1_rho256_ricker_mix256_512_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_postfix_docorder/K1_rho256_ricker_mix256_512_s42/train/%j_K1_rho256_ricker_mix256_512_s42_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_postfix_docorder/K1_rho256_ricker_mix256_512_s42"
PHASE1_OUT="${RUN_OUT}/phase1_256"
MASTER_PORT=$((12000 + SLURM_JOB_ID % 20000))
mkdir -p "${RUN_OUT}/train" "${PHASE1_OUT}"
...
wavelet_ctxscale_scale_max_exp=16
