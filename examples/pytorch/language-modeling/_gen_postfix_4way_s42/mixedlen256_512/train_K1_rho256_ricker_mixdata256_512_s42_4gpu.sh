#!/bin/bash
#SBATCH --job-name=postfix_K1_rho256_ricker_mixdata256_512_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_postfix_docorder/K1_rho256_ricker_mixdata256_512_s42/train/%j_K1_rho256_ricker_mixdata256_512_s42_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_postfix_docorder/K1_rho256_ricker_mixdata256_512_s42"
...
BLOCK_SIZE=2048
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/postfix_K1_rho256_ricker_mixdata256_512_s42_ckpt15000/L${BLOCK_SIZE}"
mkdir -p "${OUTPUT_DIR}"
...
echo "=== Done: postfix_K1_rho256_ricker_mixdata256_512_s42 L${BLOCK_SIZE} ==="
