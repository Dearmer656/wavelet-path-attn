#!/bin/bash
#SBATCH --job-name=postfix_hp2048_K1_rho256_ricker_s42_mult2x
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_postfix_K1_rho256_ricker_s42_mult2x_ckpt15000_hotpot2048.txt
...
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_postfix_4way_s42/evalmult2x/K1_rho256_ricker_s42_mult2x.cfg"
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/postfix_K1_rho256_ricker_s42_mult2x_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: postfix_K1_rho256_ricker_s42_mult2x L${BLOCK_SIZE} ==="
