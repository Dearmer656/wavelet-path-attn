#!/bin/bash
#SBATCH --job-name=one_row_logit_line
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_postfix_4way_s42/logs/%j_one_row_logit_line.txt
...
python ./plot_one_row_logit_line.py
echo "=== done ==="
