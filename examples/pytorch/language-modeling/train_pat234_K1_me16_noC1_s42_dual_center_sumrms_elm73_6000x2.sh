#!/bin/bash
#SBATCH --job-name=PAT234_K1m16_s42_dualSumRMS_elm73
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me16_noC1_s42_dual_center_sumrms/train/%j_K1_dual_sumrms_train_eval_elm73_6000x2.txt
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K1_me16_s42_dual_center_sumrms_hotpot4096_elm73_6000x2_bs2.sh"
