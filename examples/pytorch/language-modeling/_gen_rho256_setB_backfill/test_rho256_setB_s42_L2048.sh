#!/bin/bash
#SBATCH --job-name=hp2048_rho256setB_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_rho256setB_s42_L2048.txt
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me16_noC1_s42_center0_ricker_norouterrms_lang01_a100x2/checkpoint-15000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me16_noC1_s42_center0_ricker_norouterrms_lang01_a100x2/supply_model.cfg"
BLOCK_SIZE=2048
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/K1_me16_noC1_s42_center0_ricker_norouterrms_lang01_a100x2_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: rho256setB s42 L${BLOCK_SIZE} ==="
