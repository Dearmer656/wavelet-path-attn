#!/bin/bash
#SBATCH --job-name=hp2048_rho256setB_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_rho256setB_s43_L2048.txt
...
echo "=== Done: rho256setB s43 L${BLOCK_SIZE} ==="
