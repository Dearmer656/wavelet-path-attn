#!/bin/bash
#SBATCH --job-name=hp4096_K4me8_indRMS_c0_3090
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K4_me8_16_20_24_noC1_s42_independent_rms_center0_ricker_3090x4_ckpt15000_hotpot4096_bs2.txt
...
RUN_OUT="${LANG_MODEL_DIR}/runs/pat234_scale_card/K4_me8_16_20_24_noC1_s42_independent_rms_center0_ricker_3090x4"
CHECKPOINT="${RUN_OUT}/checkpoint-15000"
CFG_PATH="${RUN_OUT}/supply_model.cfg"
MODEL_NAME="K4_me8_16_20_24_noC1_s42_independent_rms_center0_ricker_3090x4_ckpt15000"
BLOCK_SIZE=4096
