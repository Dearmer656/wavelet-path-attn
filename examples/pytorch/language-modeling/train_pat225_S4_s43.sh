#! /bin/bash
#SBATCH --job-name=PAT225_S4s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/S4_s43/train/%j_pat225_S1_s42.txt
...
# PAT-225 L3: K=4 full support, s43 (seed confirmation)
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/S4_s43"
