#! /bin/bash
#SBATCH --job-name=PAT225_K8_s44_zeroinit
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat225_scale_card/K8_s44_zeroinit/train/%j_pat225_K8_s44_zeroinit.txt
...
RUN_OUT="${WORKDIR}/runs/pat225_scale_card/K8_s44_zeroinit"
