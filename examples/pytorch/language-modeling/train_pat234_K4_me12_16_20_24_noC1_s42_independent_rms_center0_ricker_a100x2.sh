#!/bin/bash
#SBATCH --job-name=PAT234_K4me12_indRMS_c0
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K4_me12_16_20_24_noC1_s42_independent_rms_center0_ricker/train/%j_K4_me12_16_20_24_independent_rms_center0_train_eval_a100x2.txt
...
bash "${WORKDIR}/test_pat234_K4_me12_16_20_24_independent_rms_center0_ricker_hotpot4096_a100x2_bs2.sh"
