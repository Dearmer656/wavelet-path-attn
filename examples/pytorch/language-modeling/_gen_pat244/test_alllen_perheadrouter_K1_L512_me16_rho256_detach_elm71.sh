#!/bin/bash
#SBATCH --job-name=hp_alllen_perhead_rho256_detach
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_perheadrouter_K1_L512_me16_rho256_detach_ckpt15000_hotpot_alllen.txt
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/perheadrouter_K1_L512_me16_rho256_detach_elm71/checkpoint-15000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/perheadrouter_K1_L512_me16_rho256_detach_elm71/supply_model.cfg"
...
for BLOCK_SIZE in 512 2048 4096; do
  OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/perheadrouter_K1_L512_me16_rho256_detach_ckpt15000/L${BLOCK_SIZE}"
  ...
  echo "=== perheadrouter_K1_L512_me16_rho256_detach ckpt15000 L${BLOCK_SIZE} (bs=${EVAL_BS}) ==="
...
echo "=== All hotpot-long lengths done for perheadrouter_K1_L512_me16_rho256_detach ckpt15000 ==="
