#!/bin/bash
#SBATCH --job-name=hp2048_perheadrouter_K1_L512_me18_rho512_detach_elm72
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_perheadrouter_K1_L512_me18_rho512_detach_elm72_ckpt15000_hotpot2048.txt
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/perheadrouter_K1_L512_me18_rho512_detach_elm72_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: perheadrouter_K1_L512_me18_rho512_detach_elm72 L${BLOCK_SIZE} ==="
