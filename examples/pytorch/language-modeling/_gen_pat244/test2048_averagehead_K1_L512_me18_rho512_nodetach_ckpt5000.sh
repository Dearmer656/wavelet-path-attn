...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/averagehead_K1_L512_me18_rho512_nodetach/checkpoint-5000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/averagehead_K1_L512_me18_rho512_nodetach/supply_model.cfg"
BLOCK_SIZE=2048
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/averagehead_K1_L512_me18_rho512_nodetach_ckpt5000/L${BLOCK_SIZE}"
...
echo "=== Done: averagehead_K1_L512_me18_rho512_nodetach ckpt5000 L${BLOCK_SIZE} ==="
