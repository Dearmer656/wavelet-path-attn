#!/bin/bash
#SBATCH --job-name=hp2048_full_perhead_rho256_s44_ckpt5000
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/perheadrouter_K1_L512_me16_rho256_detach_s44/checkpoint-5000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/perheadrouter_K1_L512_me16_rho256_detach_s44/supply_model.cfg"
BLOCK_SIZE=2048
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/perheadrouter_K1_L512_me16_rho256_detach_s44_ckpt5000_full/L${BLOCK_SIZE}"
...
echo "=== Done: perheadrouter_K1_L512_me16_rho256_detach_s44 ckpt5000 L${BLOCK_SIZE} FULL ==="
