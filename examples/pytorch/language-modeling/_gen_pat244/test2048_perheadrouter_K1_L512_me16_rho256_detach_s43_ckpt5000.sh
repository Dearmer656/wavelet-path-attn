#!/bin/bash
#SBATCH --job-name=hp2048_perhead_rho256_s43_ckpt5000
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_perheadrouter_K1_L512_me16_rho256_detach_s43_ckpt5000_hotpot2048.txt
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/perheadrouter_K1_L512_me16_rho256_detach_s43_ckpt5000/L${BLOCK_SIZE}"
...
echo "=== Done: perheadrouter_K1_L512_me16_rho256_detach_s43 ckpt5000 L${BLOCK_SIZE} ==="
