#!/bin/bash
#SBATCH --job-name=hp4096_perheadrouter_K1_L512_me18_rho512_nodetach
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_perheadrouter_K1_L512_me18_rho512_nodetach_ckpt15000_hotpot4096.txt
#SBATCH --partition=gpu_long
#SBATCH --gres=gpu:a6000:2 --nodelist=elm67
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/perheadrouter_K1_L512_me18_rho512_nodetach_6000x4/checkpoint-15000"
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/perheadrouter_K1_L512_me18_rho512_nodetach_6000x4_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: perheadrouter_K1_L512_me18_rho512_nodetach_6000x4 L${BLOCK_SIZE} ==="
