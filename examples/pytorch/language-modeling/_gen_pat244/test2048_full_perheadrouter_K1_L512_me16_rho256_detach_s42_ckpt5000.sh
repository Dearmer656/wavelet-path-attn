#!/bin/bash
#SBATCH --job-name=hp2048_full_perhead_rho256_s42_ckpt5000
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_perheadrouter_K1_L512_me16_rho256_detach_s42_ckpt5000_hotpot2048_full.txt
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/perheadrouter_K1_L512_me16_rho256_detach_elm71/checkpoint-5000"
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/perheadrouter_K1_L512_me16_rho256_detach_s42_ckpt5000_full/L${BLOCK_SIZE}"
...
echo "=== Done: perheadrouter_K1_L512_me16_rho256_detach_s42 ckpt5000 L${BLOCK_SIZE} FULL ==="
