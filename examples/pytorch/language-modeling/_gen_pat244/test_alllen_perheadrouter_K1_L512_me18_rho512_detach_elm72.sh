#!/bin/bash
#SBATCH --job-name=hp_alllen_perhead_detach
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_perheadrouter_K1_L512_me18_rho512_detach_ckpt15000_hotpot_alllen.txt
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/perheadrouter_K1_L512_me18_rho512_detach_elm72/checkpoint-15000"
...
# This small-model K1/L512 checkpoint family's hotpot_long_dev_uniform.jsonl only has
# examples packed at these 3 target lengths (verified by counting meta.target_total_tokens
# in the file: 512->7363, 2048->7404, 4096->7404) -- there is no longer-length data to test
...
echo "=== All hotpot-long lengths done for perheadrouter_K1_L512_me18_rho512_detach ckpt15000 ==="
