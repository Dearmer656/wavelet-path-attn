...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/perheadrouter_K1_L512_me18_rho512_nodetach_ckpt5000/L${BLOCK_SIZE}"
...
echo "=== Done: perheadrouter_K1_L512_me18_rho512_nodetach ckpt5000 L${BLOCK_SIZE} ==="
