#!/bin/bash
#SBATCH --job-name=PAT234_K1m19p17_L1024_c0_norrms_6000x4
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me19p1699_noC1_s42_center0_ricker_norouterrms_L1024_6000x4/train/%j_K1_me19p1699_s42_center0_ricker_norouterrms_L1024_6000x4_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me19p1699_noC1_s42_center0_ricker_norouterrms_L1024_6000x4"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K1_me19p1699_s42_center0_ricker_norouterrms_L1024_6000x4_hotpot4096_bs2.sh"
