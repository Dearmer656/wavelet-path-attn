#!/bin/bash
#SBATCH --job-name=hp4096_K5indRMS_elm43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K5_me8_12_16_20_24_independent_rms_center0_ricker_elm43_a100x2_ckpt15000_hotpot4096_elm43_a100x2_bs2.txt
...
MODEL_NAME="K5_me8_12_16_20_24_noC1_s42_independent_rms_center0_ricker_elm43_a100x2_ckpt15000"
BLOCK_SIZE=4096
