#!/bin/bash
#SBATCH --job-name=MedMix_K1rho256_ricker_s44
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/mix_medium_K1_rho256_ricker_s44/train/%j_train.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/mix_medium_K1_rho256_ricker_s44"
...
sbatch "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_pat244_medium/test_mix_medium_K1_rho256_ricker_s44.sh"
echo "=== Done: mix_medium_K1_rho256_ricker_s44 ==="
