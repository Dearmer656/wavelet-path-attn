#!/bin/bash
#SBATCH --job-name=hp4096triton_medK1_rho256_ricker_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_medK1_rho256_ricker_s43_ckpt15000_hotpot4096triton.txt
...
echo "=== Done: mix_medium_K1_rho256_ricker_s43 L${BLOCK_SIZE} (triton) ==="
