#!/bin/bash
#SBATCH --job-name=hpL512_2048_medPAonly_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_medPAonly_s43_ckpt15000_hotpotL512_2048.txt
