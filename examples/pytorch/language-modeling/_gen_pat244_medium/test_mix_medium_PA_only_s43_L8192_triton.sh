#!/bin/bash
#SBATCH --job-name=hp8192triton_medPAonly_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_medPAonly_s43_ckpt15000_hotpot8192.txt
