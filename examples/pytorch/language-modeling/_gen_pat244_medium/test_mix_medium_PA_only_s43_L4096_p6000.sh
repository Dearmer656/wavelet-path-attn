#!/bin/bash
#SBATCH --job-name=hpL4096_medPAonly_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_medPAonly_s43_ckpt15000_hotpotL4096.txt
...
echo "=== Done: mix_medium_PA_only_s43 L4096 ==="
