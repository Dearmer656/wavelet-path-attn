#!/bin/bash
#SBATCH --job-name=hp16384triton_medPAonly_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_medPAonly_s43_ckpt15000_hotpot16384.txt
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/mix_medium_PA_only_s43/checkpoint-15000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/mix_medium_PA_only_s43/supply_model.cfg"
BLOCK_SIZE=16384
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/mix_medium_PA_only_s43_triton_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: mix_medium_PA_only_s43 L${BLOCK_SIZE} triton ==="
