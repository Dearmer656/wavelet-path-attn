#!/bin/bash
#SBATCH --job-name=hpL4096_medK1_rho256_ricker_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_medK1_rho256_ricker_s43_ckpt15000_hotpotL4096.txt
...
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/mix_medium_K1_rho256_ricker_s43_ckpt15000/L${BLOCK_SIZE}"
