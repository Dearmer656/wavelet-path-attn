#!/bin/bash
#SBATCH --job-name=hpL512_medK1_rho256_ricker_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_medK1_rho256_ricker_s43_ckpt15000_hotpotL512.txt
