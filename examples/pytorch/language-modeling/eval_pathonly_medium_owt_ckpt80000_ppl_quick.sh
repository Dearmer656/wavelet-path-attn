...
# protocol as the Rotary/ALiBi checks (L1024/L2048, 1000-sample cap). pe_method=vanilla
...
echo "=== Done: PaTH-only medium ckpt80000 quick ppl (L1024, L2048, 1000 samples each) ==="
