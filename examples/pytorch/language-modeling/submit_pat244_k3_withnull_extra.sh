...
K3_SME='[12, 14, 15.169925001442312]'
# K3 with_null (competitive) + sum-then-RMS: the "important" comparison points vs independent
emit_and_submit K3_r64_128_192_withnull_none       3 "${K3_SME}" none      '#SBATCH --gres=gpu:6000:2'  rms with_null
emit_and_submit K3_r64_128_192_withnull_rmsjoint   3 "${K3_SME}" rms_joint '#SBATCH --gres=gpu:6000:2'  rms with_null
emit_and_submit K3_r64_128_192_withnull_A_dualtemp 3 "${K3_SME}" dual_temp '#SBATCH --gres=gpu:a6000:2' rms with_null
echo "=== 3 K3 with_null extras submitted ==="
