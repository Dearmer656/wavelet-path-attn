#! /bin/bash
#SBATCH --job-name=PAT234_K1_me8_NOnorm_noC1_s42
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me8_NOnorm_noC1_s42/train/%j_train.txt
...
# PAT-234: QWAB capacity test — K=1, norm-off, CENTER OFF + NORM OFF (raw wavelet).
# Paired atomic test vs variant C (center on). Only delta between A and C is
#   wavelet_logit_bias_center_enable (false here) — set via supply_model.cfg.
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me8_NOnorm_noC1_s42"
