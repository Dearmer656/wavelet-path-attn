#!/bin/bash
#SBATCH --job-name=hp4096triton_medK3_ricker_s44
...
CHECKPOINT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/mix_medium_K3_ricker_128_256_384_s44/checkpoint-15000"
CFG_PATH="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/mix_medium_K3_ricker_128_256_384_s44/supply_model.cfg"
BIAS_TYPE=$(grep -oP '(?<=bias_type=")[^"]+' "${CFG_PATH}")
BLOCK_SIZE=4096
[ -d "${CHECKPOINT}" ] || { echo "Missing ${CHECKPOINT}" >&2; exit 1; }
OUTPUT_DIR="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/results_uniform/mix_medium_K3_ricker_128_256_384_s44_triton_ckpt15000/L${BLOCK_SIZE}"
...
echo "=== Done: mix_medium_K3_ricker_128_256_384_s44 L${BLOCK_SIZE} ==="
