#!/bin/bash
#SBATCH --job-name=hp4096_K5rho128_194_256_320_384
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K5_me14_15p1998_16_16p6439_17p1699_noC1_s42_independent_rms_center0_ricker_ckpt15000_hotpot4096_lang01_a100x4_bs2.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K5_me14_15p1998_16_16p6439_17p1699_noC1_s42_independent_rms_center0_ricker_lang01_a100x4"
CHECKPOINT="${RUN_OUT}/checkpoint-15000"
CFG_PATH="${RUN_OUT}/supply_model.cfg"
MODEL_NAME="K5_me14_15p1998_16_16p6439_17p1699_noC1_s42_independent_rms_center0_ricker_lang01_a100x4_ckpt15000"
BLOCK_SIZE=4096
