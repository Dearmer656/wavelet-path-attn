#!/bin/bash
#SBATCH --job-name=hp2048_K1m14_L256_c0_norrms
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K1_me14_noC1_s42_center0_ricker_norouterrms_L256_elm43_a100x4_ckpt15000_hotpot2048_bs2.txt
