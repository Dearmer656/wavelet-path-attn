#!/bin/bash
#SBATCH --job-name=PAT234_K4me12_indRMS_cq
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K4_me12_16_20_24_noC1_s42_independent_rms_center_at_query_ricker/train/%j_K4_me12_16_20_24_independent_rms_center_at_query_train_eval_a100x2.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K4_me12_16_20_24_noC1_s42_independent_rms_center_at_query_ricker"
...
wavelet_ctxscale_scale_max_exp=[12, 16, 20, 24]
multiscale_norm="rms"
wavelet_ctxscale_pattern_mode="ricker"
wavelet_ctxscale_center_pos_ratio=1.0
...
bash "${WORKDIR}/test_pat234_K4_me12_16_20_24_independent_rms_center_at_query_ricker_hotpot4096_a100x2_bs2.sh"
