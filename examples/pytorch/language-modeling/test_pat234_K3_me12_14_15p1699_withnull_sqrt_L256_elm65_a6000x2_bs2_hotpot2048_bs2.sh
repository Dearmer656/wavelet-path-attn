#!/bin/bash
#SBATCH --job-name=hp2048_K3_L256_withnull_sqrt_elm65
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/hotpot_long/logs/%j_K3_me12_14_15p1699_noC1_s42_withnull_sqrt_L256_elm65_a6000x2_bs2_ckpt15000_hotpot2048_bs2.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K3_me12_14_15p1699_noC1_s42_withnull_sqrt_L256_elm65_a6000x2_bs2"
CHECKPOINT="${RUN_OUT}/checkpoint-15000"
CFG_PATH="${RUN_OUT}/supply_model.cfg"
MODEL_NAME="K3_me12_14_15p1699_noC1_s42_withnull_sqrt_L256_elm65_a6000x2_bs2_ckpt15000"
BLOCK_SIZE=2048
