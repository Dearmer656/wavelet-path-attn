#!/bin/bash
#SBATCH --job-name=clamp_util
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/_clamputil_%j.txt
...
python ./probe_clamp_utilization.py
echo "=== done ==="
