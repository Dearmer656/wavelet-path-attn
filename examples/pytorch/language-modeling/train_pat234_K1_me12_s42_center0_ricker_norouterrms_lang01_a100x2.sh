#!/bin/bash
#SBATCH --job-name=PAT234_K1m12_c0_norrms_a100
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K1_me12_noC1_s42_center0_ricker_norouterrms_lang01_a100x2/train/%j_K1_me12_s42_center0_ricker_norouterrms_lang01_a100x2_train_eval.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K1_me12_noC1_s42_center0_ricker_norouterrms_lang01_a100x2"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K1_me12_s42_center0_ricker_norouterrms_lang01_a100x2_hotpot4096_bs2.sh"
