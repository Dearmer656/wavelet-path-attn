#!/bin/bash
#SBATCH --job-name=PAT234_K5rho128_194_256_320_384
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat234_scale_card/K5_me14_15p1998_16_16p6439_17p1699_noC1_s42_independent_rms_center0_ricker_lang01_a100x4/train/%j_K5_me14_15p1998_16_16p6439_17p1699_independent_rms_center0_train_eval_lang01_a100x4.txt
...
RUN_OUT="${WORKDIR}/runs/pat234_scale_card/K5_me14_15p1998_16_16p6439_17p1699_noC1_s42_independent_rms_center0_ricker_lang01_a100x4"
...
wavelet_ctxscale_disable_layer_gate=false
...
wavelet_ctxscale_k=5
wavelet_ctxscale_scale_max_exp=[14, 15.199825684374256, 16, 16.643856189774723, 17.169925001442312]
multiscale_norm="rms"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/test_pat234_K5_me14_15p1998_16_16p6439_17p1699_independent_rms_center0_ricker_hotpot4096_lang01_a100x4_bs2.sh"
