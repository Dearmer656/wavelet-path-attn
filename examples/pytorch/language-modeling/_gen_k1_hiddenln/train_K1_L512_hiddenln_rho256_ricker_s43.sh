#!/bin/bash
#SBATCH --job-name=K1_L512_hiddenln_rho256_ricker_s43
#SBATCH --output=/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_hiddenln_rho256_ricker_s43/train/%j_K1_L512_me16_rho256_ricker_s43_train_eval.txt
...
RUN_OUT="/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/runs/pat244_dual_temp/K1_L512_hiddenln_rho256_ricker_s43"
...
wavelet_ctx_feat_mode="hidden_ln"
...
bash "/cl/work5/hongyu-s/transformers/examples/pytorch/language-modeling/_gen_k1_hiddenln/test_K1_L512_hiddenln_rho256_ricker_s43.sh"
